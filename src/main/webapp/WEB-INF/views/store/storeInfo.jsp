<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<![endif]-->
					...
					<body>
						...
						<header id="gtco-header" class="gtco-cover-sub gtco-cover-md" role="banner"
									...
									<div class="col-md-12 col-md-offset-0 text-center">
										...
										<div class="row row-mt-8em">
											<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
												<h2 class="white-color" style="font-size: 80px; font-weight: bold;">
													${store.sname}</h2>
											</div>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="container">
									...
									<input type="hidden" class="uid" name="uid" value="1"> <input type="text"
										class="form-data rcontent"> <input type="text" class="form-data rscore">
									<button class="btn btn-primary" type="button" onclick="insertAjax()">리뷰
										등록하기</button>
								</div>
							</div>
						</div>
